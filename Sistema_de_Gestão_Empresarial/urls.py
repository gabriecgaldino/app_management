...
from Market.views import market_view, developer_login_view, developer_view, developer_logout_view, app_review, app_remove
from . import views
urlpatterns = [
    ...
    path('developer/app_remove/<int:app_id>', app_remove, name='app_remove')
